...
public class AudioManager : MonoBehaviour {
    ...
    public static void playAThing(string eventName, GameObject obj)
    {
        //Fabric.EventManager.Instance.PostEvent(eventName, Fabric.EventAction.LoadAudio, null, obj);
        Fabric.EventManager.Instance.PostEvent(eventName, Fabric.EventAction.PlaySound, null, obj);
    }
