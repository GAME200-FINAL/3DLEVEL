...
public class Inventory : MonoBehaviour
{
    ...
    public string itemDatabaseLocation = "/Scripts/InventorySystem/ItemDatabase.json";
    ...
    {
        jsonItemDB = JsonMapper.ToObject(File.ReadAllText(Application.dataPath + itemDatabaseLocation));
    ...
    public bool RemoveItemByTitle(string title)
    {
        for (int i = 0; i < itemDatabase.Count; ++i)
